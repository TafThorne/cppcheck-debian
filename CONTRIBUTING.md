...
Cppcheck tool installed.  You can find more about these two projects on their
own pages:
...
Please file a bug under the cppcheck-debian GitHub project.  Make sure to
...
Please ensure that you build a Docker Image to test your new Dockerfile:
 docker build -t tafthorne/cppcheck-debian -f ./Dockerfile.cppcheck-debian .
